...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://267q6olw0h.execute-api.us-east-1.amazonaws.com/test-stage';
    ...
    apigClient.uploadBucketObjectPut = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(uploadBucketObjectPutRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.uploadBucketObjectOptions = function (params, body, additionalParams) {
        ...
        return apiGatewayClient.makeRequest(uploadBucketObjectOptionsRequest, authType, additionalParams, config.apiKey);
    };
